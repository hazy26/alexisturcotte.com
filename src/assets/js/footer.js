...
footer.innerHTML = `
    <section id="contact" class="flex flex-col gap-4 grow-1 p-2 w-full font-8 max-w-540 self-center">
        ...
        <a href="mailto:dev@aturcotte.com" class="no-underline border-2 items-center flex space-between px-2 py-1 font-7 weight-500 shadow-sm color-secondary tilt-link transition">
            <span>discutons</span>
