...
competences.className = "flex flex-col gap-2 px-1";
competences.innerHTML = `
    ...
    <p class="weight-500 font-5 letter-spacing-1">- conception de site web, intégration web, javascript, html, css, sass, node.js, sql, wordpress, figma, suite adobe -</p>
`;
